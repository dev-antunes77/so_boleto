...
abstract class AppThemeValues {
  ...
  ///6px
  static const spaceXXXSmall = 6.0;
  ...
  ///6px
  static const spaceVerticalXXXSmall = SizedBox(height: spaceXXXSmall);
  ...
  ///6px
  static const spaceHorizontalXXXSmall = SizedBox(width: spaceXXXSmall);
